            ...
            <div className="space-y-4 md:space-y-6">
              {farmingActivities.map((activity, index) => (
                <div key={activity.title} className="flex items-start gap-3 md:gap-4 group">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-[#2d4a2d]/10 rounded-full flex items-center justify-center shrink-0 group-hover:bg-[#2d4a2d] transition-colors duration-300">
                    <activity.icon className="w-4 h-4 md:w-5 md:h-5 text-[#2d4a2d] group-hover:text-white transition-colors duration-300" />
                  </div>
                  <div>
